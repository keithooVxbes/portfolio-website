...
export function SkillBadge({ name, level }: SkillBadgeProps) {
  return (
    <motion.div
      ...
      whileHover={{ y: -5 }}
    >
      <div className="relative flex items-center justify-center overflow-hidden rounded-xl bg-zinc-800/50 backdrop-blur-sm border border-zinc-700/50 p-6 h-full transition-all duration-300 hover:border-cyan-500/50">
